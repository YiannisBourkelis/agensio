...
sed "s#@WORKERS@#$AGENSIO_WORKERS#g; s#@BENCH@#$BENCH#g; s#@SENDFILE_MIN@#$SENDFILE_MIN#g; s#@ACCESS_LOG@#$ACCESS_LOG#g; s#@H3@##g" "$BENCH/agensio.toml" > "$BENCH/tmp/agensio.toml"
